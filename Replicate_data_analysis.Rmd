...
validation_2<-DotPlot(mouse_pn_val,idents = mouse_in,assay = "chromvar",features =  features,cols=c('#3182bd',"#de2d26")) + theme(legend.position="top")+ggtitle(label = "Mouse validation") +ylab(label = "")+ scale_x_discrete(labels=motif_labels[-c(1:5,11:15,26,27,33:42,48:51,57:61)])+theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=0.5))+xlab(label = "")+theme(axis.title.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank())


p_mouse_mouse_validation_plot<-p2_orig|validation_2


ggsave(p_mouse_mouse_validation_plot,filename = "/home/torkenczyk/H_M_chromatin_atlas/human_data/plots/paper_pdfs/mouse_mouse_validation_dotplot.pdf",width = 20,height = 7.5)
...
ggsave(p1_orig_ho+p2_orig_ho,filename = "/home/torkenczyk/H_M_chromatin_atlas/human_data/plots/paper_pdfs/Human_only_orig_dotplot.pdf",width = 20,height = 7.5)
...
ggsave(p1_orig_mo+p2_orig_mo,filename = "/home/torkenczyk/H_M_chromatin_atlas/human_data/plots/paper_pdfs/Mouse_only_orig_dotplot.pdf",width = 20,height = 7.5)
...
ggsave(p1_orig_ho+validation_2_a_h,filename = "/home/torkenczyk/H_M_chromatin_atlas/human_data/plots/paper_pdfs/Human_val_orig_dotplot.pdf",width = 20,height = 7.5)

ggsave(p2_orig_ho+validation_2_b_h,filename = "/home/torkenczyk/H_M_chromatin_atlas/human_data/plots/paper_pdfs/Mouse_val_orig_h_only_dotplot.pdf",width = 20,height = 7.5)

ggsave(p1_orig_mo+validation_2_a_m,filename = "/home/torkenczyk/H_M_chromatin_atlas/human_data/plots/paper_pdfs/Human_val_orig_m_only_dotplot.pdf",width = 20,height = 7.5)

ggsave(p2_orig_mo+validation_2_b_m,filename = "/home/torkenczyk/H_M_chromatin_atlas/human_data/plots/paper_pdfs/Mouse_val_orig_m_only_dotplot.pdf",width = 20,height = 7.5)
